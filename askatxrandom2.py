...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[ASKAT] %s \x1b[1;95m  Your Expired Apps     :{WHITE}'%(M))
        for i in range(len(game)):
            print(f"\r[ASKAT] %s%s"%(N,i+1,game[i].replace("Kedaluwarsa"," Kedaluwarsa"),N))
        else:
            print('')
...
\033[0;92mâ•šâ•WELCOME TO ASKAT CYBER RANDOM CLONING COMAND\033[1;31m
    """) 
loop = 0
oks = []
cps = []
